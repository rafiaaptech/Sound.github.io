...
<body style="background-image: url(img/bg9.jpg); background-size: 1800px; background-repeat: no-repeat">
...
<img src="admin/img/<?php echo $fetch['Song_Image']?>" width="510px"  height= "450px"></a>
